...
//加密实现
static void DES_E(char input[8], char key_in[8], int output[64])
{
...
//解密实现
static void DES_D(int input[64], char key_in[8], char output[8])
{
  int Ip[64] = {0}; //存储初始置换后的矩阵
  int output_1[64] = {0};
  int output_2[64] = {0};
